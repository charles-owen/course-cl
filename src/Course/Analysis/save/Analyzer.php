...
class Analyzer {
	/**
	 * Constructor
	 * @param \Assignments\Submission $submission Submission we are analyzing
	 * @param $path Path to any file for the submission
	 */
    public function __construct(\Assignments\Submission $submission, $path=null) {
     ...
     */
    public function get_unzipped_dir() {
        if($this->unzipDir === null) {
			...
			$course = $this->submission->get_assignment()->get_course();
